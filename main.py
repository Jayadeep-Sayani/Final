...
def genetic_algorithm(schedule_requests, sequencing_rules, population_size=120, generations=10, mutation_rate=0.3, elitism_size=5):
...
if __name__ == "__main__":
    ...
    for schedule in schedule_requests:
        if len(schedule.requested_main_courses) == 8:
            ...
            requested_main_or_alt_names = requested_course_names.union(
                {course.name for course in schedule.requested_alternative_courses}
            )
